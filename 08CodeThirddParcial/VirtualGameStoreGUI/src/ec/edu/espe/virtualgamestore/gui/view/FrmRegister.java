...
import ec.edu.espe.virtualgamestore.controller.ValidateUser;
...
public class FrmRegister extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(principalPnl, javax.swing.GroupLayout.PREFERRED_SIZE, 902, Short.MAX_VALUE)
        );
    ...
    private void RegisterBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RegisterBTNActionPerformed
        ...
        objectUserName.put("name", userTxt.getText());
        objectUser.put("Password", passwordRegisterPswf.getText());
        objectUser.put("Email", emailTxt.getText());
        objectData.put("name", userTxt.getText());
        objectData.put("Password", passwordRegisterPswf.getText());
        objectUser.put("Age", ageTxt.getText());
        objectUser.put("name", userTxt.getText());
        objectUser.put("Password", passwordRegisterPswf.getText());

        if (!validateUser.validateUser(userTxt.getText(), "Users.json")) {
            if (validateUser.validateEmail(emailTxt.getText())) {
                if (!validateUser.emailConfirmation(emailTxt.getText(), "UserData.json")) {
                    JOptionPane.showMessageDialog(null, "Usuario registrado");

                    fileManager.writeJson(objectData, "Users.json");
                    fileManager.writeJson(objectUser, "UserData.json");
                    FrmLogInUser frmLogIn = new FrmLogInUser();
                    frmLogIn.setVisible(true);
                    this.setVisible(false);
                } else {
                    JOptionPane.showMessageDialog(null, "Su email ya existe, elija otro email");
                }

            }

        } else {
            JOptionPane.showMessageDialog(null, "Su usuario ya existe, elija otro usuario");
